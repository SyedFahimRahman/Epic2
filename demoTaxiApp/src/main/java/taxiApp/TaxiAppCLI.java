            ...
            switch (choice) {
                ...
                case 4:
                    ...
                    if (vehicleLocation != null) {
                        System.out.println("taxiApp.Vehicle location: " + vehicleLocation.getY() + ", " + vehicleLocation.getX());
                    } else {
                        System.out.println("taxiApp.Vehicle not found or not on the map.");
                    }
                    break;
                ...
                case 8:
                    System.out.println("Exiting the taxiApp.Taxi Hiring App. Goodbye!");
                    System.exit(0);
